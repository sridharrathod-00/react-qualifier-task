    ...
    <div className="flex flex-col flex-1 justify-between py-2 w-full">
      ...
      <div className="flex flex-col gap-3 w-full mb-4">
        <button
          ...
          className="w-full py-3 bg-violet-600 hover:bg-violet-700 text-white font-medium rounded-xl text-sm transition-colors cursor-pointer"
        >
          Create Account
        </button>
        <button
          onClick={() => navigate("/login")}
          className="w-full py-3 bg-slate-100 hover:bg-slate-200 text-slate-800 font-medium rounded-xl text-sm transition-colors cursor-pointer"
        >
